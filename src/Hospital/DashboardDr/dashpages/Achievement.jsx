...
const Achievement = () => {
    ...
    useEffect(() => {
        ...
        onValue(ref(database, `Achievement/Hospital/${id}/1`), (snapshot) => {
            if (snapshot.exists()) {
        ...
        onValue(ref(database, `Achievement/Hospital/${id}/2`), (snapshot) => {
            if (snapshot.exists()) {
        ...
        onValue(ref(database, `Achievement/Hospital/${id}/3`), (snapshot) => {
            if (snapshot.exists()) {
        ...
        onValue(ref(database, `Achievement/Hospital/${id}/4`), (snapshot) => {
            if (snapshot.exists()) {
        ...
        onValue(ref(database, `Achievement/Hospital/${id}/5`), (snapshot) => {
            if (snapshot.exists()) {
        ...
        onValue(ref(database, `Achievement/Hospital/${id}/6`), (snapshot) => {
            if (snapshot.exists()) {
        ...
        onValue(ref(database, `Achievement/Hospital/${id}/description`), (snapshot) => {
            if (snapshot.exists()) {
                setDescriptionTxt(snapshot.val().description);
                console.log("ak " + descriptionTxt);
            } else {
                // Handle the case when the data doesn't exist
    ...
    const postListRef = ref(database, `Achievement/Hospital/${id}`);
    ...
    function uploadData() {
        const imgRef = ref_storage(storage, `Achievement/Hospital/${id}/Achievement/1`);
        ...
        uploadTask
            .then((snapshot) => {
                ...
                getDownloadURL(snapshot.ref).then((url) => {
                    ...
                    putData(`Achievement/Hospital/${id}/1`, { url1: url, text1: text1 })
    ...
    function uploadData2() {
        const imgRef = ref_storage(storage, `Achievement/Hospital/${id}/Achievement/2`);
        const uploadTask = uploadBytesResumable(imgRef, img);
        //Handle the promise returned by uploadBytesResumable
        uploadTask
            .then((snapshot) => {
                ...
                getDownloadURL(snapshot.ref).then((url) => {
                    ...
                    alert("Data uploaded succesfully, Please refresh the page")
                    putData(`Achievement/Hospital/${id}/2`, { url2: url, text2: text2 })
                });
            })
            .catch((error) => {
                console.error('Error uploading image:', error);
    ...
    function uploadData3() {
        const imgRef = ref_storage(storage, `Achievement/Hospital/${id}/Achievement/3`);
        const uploadTask = uploadBytesResumable(imgRef, img);
        //Handle the promise returned by uploadBytesResumable
        uploadTask
            .then((snapshot) => {
                ...
                getDownloadURL(snapshot.ref).then((url) => {
                    ...
                    console.log('Download URL:', url1);
                    alert("Data uploaded succesfully, Please refresh the page")
                    putData(`Achievement/Hospital/${id}/3`, { url3: url, text3: text3 })
                });
            })
            .catch((error) => {
                console.error('Error uploading image:', error);
    ...
    function uploadData4() {
        const imgRef = ref_storage(storage, `Achievement/Hospital/${id}/Achievement/4`);
        const uploadTask = uploadBytesResumable(imgRef, img);
        //Handle the promise returned by uploadBytesResumable
        uploadTask
            .then((snapshot) => {
                ...
                getDownloadURL(snapshot.ref).then((url) => {
                    ...
                    console.log('Download URL:', url1);
                    alert("Data uploaded succesfully, Please refresh the page")
                    putData(`Achievement/Hospital/${id}/4`, { url4: url, text4: text4 })
                });
            })
            .catch((error) => {
                console.error('Error uploading image:', error);
    ...
    function uploadData5() {
        const imgRef = ref_storage(storage, `Achievement/Hospital/${id}/Achievement/5`);
        const uploadTask = uploadBytesResumable(imgRef, img);
        //Handle the promise returned by uploadBytesResumable
        uploadTask
            .then((snapshot) => {
                ...
                getDownloadURL(snapshot.ref).then((url) => {
                    ...
                    console.log('Download URL:', url1);
                    alert("Data uploaded succesfully, Please refresh the page")
                    putData(`Achievement/Hospital/${id}/5`, { url5: url, text5: text5 })
                });
            })
            .catch((error) => {
                console.error('Error uploading image:', error);
    ...
    function uploadData6() {
        const imgRef = ref_storage(storage, `Achievement/Hospital/${id}/Achievement/6`);
        const uploadTask = uploadBytesResumable(imgRef, img);
        //Handle the promise returned by uploadBytesResumable
        uploadTask
            .then((snapshot) => {
                ...
                getDownloadURL(snapshot.ref).then((url) => {
                    ...
                    console.log('Download URL:', url1);
                    alert("Data uploaded succesfully, Please refresh the page")
                    putData(`Achievement/Hospital/${id}/6`, { url6: url, text6: text6 })
                });
            })
            .catch((error) => {
                console.error('Error uploading image:', error);
    ...
    const uploadText = () => {
        ...
        putData(`Achievement/Hospital/${id}/description`, { description: description })
    }
